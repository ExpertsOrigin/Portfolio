  ...
  return (
    <>
      ...
      <section className="contact-form">
        ...
        <input className='contact-form-input' name='name' type="text" placeholder="What's Your Name ?"  />
        <input className='contact-form-input' name='email' type="text" placeholder="What's Your Email Address ?"  />
        <input className='contact-form-input' name='phone' type="text" placeholder="What's Your Phone No ?"  />
        <label htmlFor=""><p className="question-p">What type of Services you are looking for ?</p> <br />
          ...
          <input className='contact-form-input last-input' name='textarea' type="text" placeholder='Tell me about your project ?' />
